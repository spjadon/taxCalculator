                ...
                <div class=" container-fluid  ">
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navigation">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="admin_dashboard.php?adminlogout='1'">
							...
							<div class="col-lg-10 mx-auto text-center"><br>
								...
								<div class="author">
                                     ...
                                     <a href="edit_admin.php">
                                      ...
                                      <h4 class="title"><small>WELCOME:</small>
                                ...
                                <div class="card-body table-full-width table-responsive">
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
											...
											<th><a href="admin_user.php"><?php echo $count4['total4'];?></a></th>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
